<h2> 417 227
2900. Longest Unequal Adjacent Groups Subsequence I</h2><hr><div><p>You are given a string array <code>words</code> and a <strong>binary</strong> array <code>groups</code> both of length <code>n</code>.</p>
